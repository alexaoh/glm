...
ggplot(data = covid.data, aes(Week)) +
  labs(x = "Week", y = "Count") +
  geom_bar(aes(fill = SEXE)) +
  ggtitle("Evolution of critical infection in weeks") +
  theme_minimal()
...
# Dette er det du hadde ;) Tror ikke dette stemmer helt, siden dette viser antall rader, men vi må vel telle opp i RECOMPTE?
# Det har jeg gjort i hvert plot under dine. Hva tenker du?
ggplot(data = covid.data, aes(Month)) +
  labs(x = "Month", y = "Count") +
  geom_bar(aes(fill = SEXE)) +
  ggtitle("Evolution of critical infection for women in months") +
  theme_minimal()
...
ggplot(data = month.data, aes(x = Month, y = Count)) +
  labs(x = "Month", y = "Count") +
  geom_col(aes(fill = SEXE), position = "dodge") +
  geom_text(aes(label=Count, group= SEXE), vjust = 1.6, color="black", 
