...
```{r}
# Mangler fortsatt analyse for å se om det er en grei fit, men ser ihvertfall
# mer normalt ut. Når vi får på plass goodness of fit measures, kan vi teste 
# den mot multinomial eventuelt, eller med interactions. Om det ser greit ut
# er det vel nok bevis til å si at vaksinasjonsstatus påvirker RECOMPTE.
```
