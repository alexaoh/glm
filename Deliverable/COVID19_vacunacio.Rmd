...
**I think Defuncio is death, and Critics are critical cases worse than just hospitalization. Lets only analyze Critics first, then see if we can/want to do more**
